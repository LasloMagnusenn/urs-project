...
export interface ERC721AURIStorageInterface extends utils.Interface {
  functions: {
...
export interface ERC721AURIStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721AURIStorageInterface;
